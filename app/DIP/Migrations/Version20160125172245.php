...
class Version20160125172245 extends AbstractMigration
{
	...
	public function up(Schema $schema)
	{
		...
		$this->addSql('ALTER TABLE users ADD CONSTRAINT FK_1483A5E9D84AB5C4 FOREIGN KEY (user_roles_id) REFERENCES user_roles (id)');
                $this->addSql('INSERT INTO user_roles (id, name, parent_role) VALUES (1, "SuperAdmin", null)');
                $this->addSql('INSERT INTO user_roles (id, name, parent_role, access_ban) VALUES (2, "Guest", null, "Admin:Settings:default,Admin:Settings:editUser,Admin:Settings:role,Admin:Settings:editRole")');
